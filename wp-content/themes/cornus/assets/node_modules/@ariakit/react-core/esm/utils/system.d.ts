 ...
 */
export declare function createComponent<O extends Options>(render: (props: Props<O>) => React.ReactElement | null): Component<O>;
/**
 ...
 * <Component customProp render={<button />} />
 */
export declare function createMemoComponent<O extends Options>(render: (props: Props<O>) => React.ReactElement | null): Component<O>;
/**
