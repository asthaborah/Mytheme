...
var useMenuSeparator = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store } = _b, props = _AV6KTKLEcjs.__objRest.call(void 0, _b, ["store"]);
    const context = _NGEKJJDHcjs.useMenuContext.call(void 0, );
    store = store || context;
    props = _F34KLJKGcjs.useCompositeSeparator.call(void 0, _AV6KTKLEcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var MenuSeparator = _RNZNGEL4cjs.createComponent.call(void 0, (props) => {
