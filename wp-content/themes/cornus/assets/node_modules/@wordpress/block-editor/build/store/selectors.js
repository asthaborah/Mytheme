...
const getAllowedPatternsDependants = select => (state, rootClientId) => {
  return [...(0, _utils.getAllPatternsDependants)(select)(state), state.settings.allowedBlockTypes, state.settings.templateLock, state.blockListSettings[rootClientId], state.blocks.byClientId.get(rootClientId)];
};
