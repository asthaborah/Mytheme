...
<!-- wp:cover {"url":"<?php echo esc_url( CORNUS_BUILD_IMG_URI . '/patterns/cover.jpg' ) ?>","id":3854,"minHeight":640,"align":"full","className":"aquila-cover"} -->
<div class="wp-block-cover alignfull has-background-dim aquila-cover" style="background-image:url(<?php echo esc_url( CORNUS_BUILD_IMG_URI . '/patterns/cover.jpg' ) ?>);min-height:640px"><div class="wp-block-cover__inner-container"><!-- wp:heading {"align":"center","level":1} -->
