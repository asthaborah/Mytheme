...
var useSelectItemCheck = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store, checked } = _b, props = _AV6KTKLEcjs.__objRest.call(void 0, _b, ["store", "checked"]);
    const context = _react.useContext.call(void 0, _2WCJJQSKcjs.SelectItemCheckedContext);
...
var SelectItemCheck = _RNZNGEL4cjs.createComponent.call(void 0, 
  (props) => {
