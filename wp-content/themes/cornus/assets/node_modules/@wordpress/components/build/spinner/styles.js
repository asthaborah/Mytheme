...
const spinAnimation = (0, _react.keyframes)`
 ...
 `;
const StyledSpinner = exports.StyledSpinner = (0, _base.default)("svg", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq2"
} : {
  target: "ea4tfvq2",
  label: "StyledSpinner"
...
const SpinnerTrack = exports.SpinnerTrack = (0, _base.default)("circle", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq1"
} : {
  target: "ea4tfvq1",
  label: "SpinnerTrack"
...
const SpinnerIndicator = exports.SpinnerIndicator = (0, _base.default)("path", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq0"
} : {
  target: "ea4tfvq0",
