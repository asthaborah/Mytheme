...
export interface HovercardStoreProps extends HovercardStoreOptions, Core.HovercardStoreProps {
}
export interface HovercardStore extends HovercardStoreFunctions, Store<Core.HovercardStore> {
}
