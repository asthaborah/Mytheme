...
var useFocusable = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      focusable = true,
    ...
    const autoFocusRef = _EO6LS72Hcjs.useEvent.call(void 0, (element) => {
      if (!focusable)
        return;
      if (!autoFocus)
        return;
    ...
    const style = trulyDisabled ? _AV6KTKLEcjs.__spreadValues.call(void 0, { pointerEvents: "none" }, props.style) : props.style;
    props = _AV6KTKLEcjs.__spreadProps.call(void 0, _AV6KTKLEcjs.__spreadValues.call(void 0, {
      ...
      ref: _EO6LS72Hcjs.useMergeRefs.call(void 0, ref, autoFocusRef, props.ref),
      style,
...
var Focusable = _RNZNGEL4cjs.createComponent.call(void 0, (props) => {
