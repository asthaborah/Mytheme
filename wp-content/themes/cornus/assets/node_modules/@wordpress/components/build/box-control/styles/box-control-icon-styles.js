...
const Root = exports.Root = (0, _base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z8"
} : {
  target: "e1j5nr4z8",
  label: "Root"
...
const Viewbox = exports.Viewbox = (0, _base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z7"
} : {
  target: "e1j5nr4z7",
  label: "Viewbox"
