...
var _2KDFQUU7cjs = require('../__chunks/2KDFQUU7.cjs');
require('../__chunks/KSAZE5E2.cjs');
...
var useMenuGroup = _RNZNGEL4cjs.createHook.call(void 0, (props) => {
  props = _2KDFQUU7cjs.useCompositeGroup.call(void 0, props);
  return props;
});
var MenuGroup = _RNZNGEL4cjs.createComponent.call(void 0, (props) => {
