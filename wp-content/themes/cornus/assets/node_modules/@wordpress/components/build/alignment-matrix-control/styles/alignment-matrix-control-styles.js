...
const Row = exports.Row = (0, _base.default)("div", process.env.NODE_ENV === "production" ? {
  target: "ecapk1j2"
} : {
  target: "ecapk1j2",
  label: "Row"
...
const Point = exports.Point = (0, _base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "ecapk1j1"
} : {
  target: "ecapk1j1",
  label: "Point"
...
const Cell = exports.Cell = (0, _base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "ecapk1j0"
} : {
  target: "ecapk1j0",
  label: "Cell"
