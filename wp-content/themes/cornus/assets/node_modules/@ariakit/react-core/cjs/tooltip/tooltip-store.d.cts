...
export interface TooltipStoreProps extends TooltipStoreOptions, Core.TooltipStoreProps {
}
export interface TooltipStore extends TooltipStoreFunctions, Store<Core.TooltipStore> {
}
