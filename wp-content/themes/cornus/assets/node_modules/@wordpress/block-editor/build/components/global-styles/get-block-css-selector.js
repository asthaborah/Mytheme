...
function getBlockCSSSelector(blockType, target = 'root', options = {}) {
  ...
  if (pathArray.length === 1) {
    ...
    if (hasSelectors) {
      ...
      const featureSelector = (0, _object.getValueFromObjectPath)(selectors, `${path}.root`, null) || (0, _object.getValueFromObjectPath)(selectors, path, null);
    ...
    const featureSelector = (0, _object.getValueFromObjectPath)(supports, `${path}.__experimentalSelector`, null);
