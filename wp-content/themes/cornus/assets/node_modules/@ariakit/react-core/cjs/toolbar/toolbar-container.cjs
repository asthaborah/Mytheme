...
var _23HLSVKMcjs = require('../__chunks/23HLSVKM.cjs');
...
var useToolbarContainer = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    ...
    store = store || context;
    props = _JQS6X2I5cjs.useCompositeContainer.call(void 0, _AV6KTKLEcjs.__spreadValues.call(void 0, { store }, props));
    props = _23HLSVKMcjs.useToolbarItem.call(void 0, _AV6KTKLEcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
