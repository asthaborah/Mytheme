 ...
 * }
 */
export declare const useMenuBarContext: () => import("../menubar/menubar-store.js").MenubarStore | undefined;
export declare const useMenuBarScopedContext: (onlyScoped?: boolean) => import("../menubar/menubar-store.js").MenubarStore | undefined;
export declare const useMenuBarProviderContext: () => import("../menubar/menubar-store.js").MenubarStore | undefined;
export declare const MenuBarContextProvider: (props: import("react").ProviderProps<import("../menubar/menubar-store.js").MenubarStore | undefined>) => import("react/jsx-runtime").JSX.Element;
export declare const MenuBarScopedContextProvider: (props: import("react").ProviderProps<import("../menubar/menubar-store.js").MenubarStore | undefined>) => import("react/jsx-runtime").JSX.Element;
